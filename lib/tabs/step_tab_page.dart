...
import '../widgets/detailed_walking_painter.dart'; // Use the detailed painter
          ...
          children: <Widget>[
            ...
            SizedBox(
              ...
              child: CustomPaint(
                ...
                painter: DetailedWalkingPainter(animation: animationController),
              ),
            ),
            ...
            // Simulation controls are only built if in simulation mode
            if (isSimulationMode)
